...
class DetailspropertyWidget extends StatefulWidget {
  const DetailspropertyWidget({
    ...
    this.standardStatus,
    this.listPrice,
    this.sTELLARExpectedClosingDate,
  }) : super(key: key);
  ...
  final DateTime? sTELLARExpectedClosingDate;
                ...
                children: [
                  FutureBuilder<ApiCallResponse>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      final pageViewSearchByMLSorSTREETResponse =
                          snapshot.data!;
                      return Builder(
                        builder: (context) {
                          final images = getJsonField(
                            pageViewSearchByMLSorSTREETResponse.jsonBody,
                            r'''$..bundle..Media''',
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Text(
                                        'Closing ${dateTimeFormat('d/M/y', widget.sTELLARExpectedClosingDate)}',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyText2
                                            .override(
                                              fontFamily: 'Outfit',
