...
class BuyerFormComponentWidget extends StatefulWidget {
  const BuyerFormComponentWidget({Key? key}) : super(key: key);
            ...
            children: [
              Padding(
                ...
                child: FlutterFlowDropDown(
                  ...
                  onChanged: (val) => setState(() => statusDropDownValue = val),
                  ...
                  children: [
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Visibility(
                          visible: statusDropDownValue != 'Executed Contract',
                          child: Container(
                            width: double.infinity,
                            child: TextFormField(
                        ...
                        child: Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              contentPadding: EdgeInsetsDirectional.fromSTEB(
                                  12, 12, 12, 12),
                              suffixIcon: escrowDespositTextFieldController!
                                      .text.isNotEmpty
                                  ? InkWell(
                                      onTap: () async {
                                        escrowDespositTextFieldController
                    ...
                    if (choiceChipsValue == 'Conventional')
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(12, 12, 12, 12),
                        child: Row(
                          mainAxisSize: MainAxisSize.max,
                          ...
                          children: [
                            Expanded(
                              child: TextFormField(
                                controller: financedAmountTextFieldController,
                                onChanged: (_) => EasyDebounce.debounce(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  contentPadding:
                                      EdgeInsetsDirectional.fromSTEB(
                                          12, 12, 12, 12),
                                  suffixIcon: financedAmountTextFieldController!
                                          .text.isNotEmpty
                                      ? InkWell(
                                          onTap: () async {
                                            financedAmountTextFieldController
                                    ...
                                    Padding(
                                      ...
                                      child: InkWell(
                                        onTap: () async {
                                          ...
                                          setState(() =>
                                              FFAppState().OfferExpirationDate =
                                                  datePicked1);
                                        },
                                        child: Icon(
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              child: TextFormField(
                                controller: inspectionPeriodTextFieldController,
                                onChanged: (_) => EasyDebounce.debounce(
                                  ...
                                  await showDialog(
                                    ...
                                    builder: (alertDialogContext) {
                                      return AlertDialog(
                                        ...
                                        content: Text('# of Inspection Days'),
                                        actions: [
                                          TextButton(
                                            onPressed: () => Navigator.pop(
                                                alertDialogContext),
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              child: TextFormField(
                                controller: additionalTermsTextFieldController,
                                onChanged: (_) => EasyDebounce.debounce(
                        ...
                        child: Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              contentPadding: EdgeInsetsDirectional.fromSTEB(
                                  12, 12, 12, 12),
                              suffixIcon: internalNotesTextFieldController!
                                      .text.isNotEmpty
                                  ? InkWell(
                                      onTap: () async {
                                        internalNotesTextFieldController
                        ...
                        onPressed: () async {
                          if (checkboxValue!) {
                            ...
                            apiResultmiv = await AirtableAPIsGroup
                              ...
                              typesOfFinancingAcceptedList: functions
                                  .singleStringToList(choiceChipsValue!),
                              additionalTerms:
                                  additionalTermsTextFieldController!.text,
                              notes: internalNotesTextFieldController!.text,
                              purchasePrice:
                                  double.parse(purchasePriceController!.text),
                              offerExpirationDate:
                                  FFAppState().OfferExpirationDate?.toString(),
                              closingDate: FFAppState().ClosingDate?.toString(),
                              preApprovalOrProofOfFundsPOF: uploadedFileUrl,
