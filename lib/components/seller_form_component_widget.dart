          ...
          children: [
            Padding(
              ...
              child: FlutterFlowDropDown(
                options: ['Active Listing', 'Pre-listing', 'Executed Contract'],
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          suffixIcon: listingPriceController!.text.isNotEmpty
                              ? InkWell(
                                  onTap: () async {
                                  ...
                                  Padding(
                                    ...
                                    child: InkWell(
                                      onTap: () async {
                                        ...
                                        setState(() =>
                                            FFAppState().ListingDateActiveDate =
                                                datePicked1);
                                      },
                                      child: Icon(
                                  ...
                                  Padding(
                                    ...
                                    child: InkWell(
                                      onTap: () async {
                                        ...
                                        setState(() =>
                                            FFAppState().ListingExpirationDate =
                                                datePicked2);
                                      },
                                      child: Icon(
                                        Icons.calendar_today,
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                suffixIcon: totalCommissionController!
                                    ...
                                    ? InkWell(
                                        onTap: () async {
                                          totalCommissionController?.clear();
                                          setState(() {});
                                        },
                                        child: Icon(
                                          Icons.clear,
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Expanded(
                            child: TextFormField(
                              controller: listingAgentCommissionController,
                              onChanged: (_) => EasyDebounce.debounce(
                              ...
                              decoration: InputDecoration(
                                ...
                                contentPadding: EdgeInsetsDirectional.fromSTEB(
                                    12, 12, 12, 12),
                                suffixIcon: listingAgentCommissionController!
                                        .text.isNotEmpty
                                    ? InkWell(
                                        onTap: () async {
                                          listingAgentCommissionController
                            ...
                            child: InkWell(
                              onTap: () async {
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      title: Text('Listing Agent Commission '),
                                      content: Text('Listing Agent Commission'),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
                                              Navigator.pop(alertDialogContext),
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Expanded(
                            child: TextFormField(
                              controller: cooperatingBrokerCommissionController,
                              onChanged: (_) => EasyDebounce.debounce(
                            ...
                            child: InkWell(
                              onTap: () async {
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      title: Text('Co-op Broker Commission'),
                                      content: Text('Buyer Agent Commission'),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
                                              Navigator.pop(alertDialogContext),
                            ...
                            onTap: () async {
                              await showDialog(
                                ...
                                builder: (alertDialogContext) {
                                  return AlertDialog(
                                    title: Text('Additional Terms'),
                                    content: Text('Example: Cancellation Fee'),
                                    actions: [
                                      TextButton(
                                        onPressed: () =>
                                            Navigator.pop(alertDialogContext),
                      ...
                      onPressed: () async {
                        if (checkboxValue!) {
                          ...
                          apiResultmiv = await AirtableAPIsGroup
                            ...
                            type: 'Seller',
                            listingPrice:
                                double.parse(listingPriceController!.text),
