                ...
                if (confirmDialogResponse) {
                  if (statusDropDownValue == 'Active Listing') {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text(
                          'Creating Active Listing Record',
                          style: TextStyle(
                    ...
                    if (statusDropDownValue == 'Pre-listing') {
                      ...
                      apiResultmiv2 = await AirtableAPIsGroup
                        ...
                        buyerSellerContactList: functions.contactRecordID(
                            FFAppState().SellerFormContactsList.toList()),
                        totalCommision: valueOrDefault<double>(
                          functions.convertToDecimalPercentage(
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text(
                            'Creating Executed Contract Record',
                            style: TextStyle(
                              color: FlutterFlowTheme.of(context).primaryText,
                            ),
                          ),
